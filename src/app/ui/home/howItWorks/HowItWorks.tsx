...
export default function HowItWorks() {
  return (
    <section className="flex w-full items-center justify-center" id="how-it-works">
      <div className="mainContainer mt-10 flex w-full max-w-[1920px] items-center justify-center rounded-3xl bg-yellowQuik py-8 md:py-12">
