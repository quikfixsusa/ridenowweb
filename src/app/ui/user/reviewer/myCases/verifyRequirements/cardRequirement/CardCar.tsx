...
import { DriverVehicle } from '@/app/lib/types/userTypes';
import Image from 'next/image';

export default function CardCar({ data }: { data: DriverVehicle }) {
  return (
    <div className="flex items-center gap-8 rounded-lg border border-gray-300 px-6 py-4">
      ...
      <div>
        <h3 className="text-2xl font-bold">{data.license_plate}</h3>
        <p className="text-lg">
